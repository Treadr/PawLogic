...
BEHAVIOR_CATEGORIES: dict[str, dict[str, list[str]]] = {
    "cat": {
        "elimination": [
            "urinated_outside_box",
            "defecated_outside_box",
            "spraying",
            "marking",
    ...
    "dog": {
        "elimination": [
            ...
            "indoor_defecation",
            "marking",
            "submissive_urination",
            "excitement_urination",
        ],
        "aggression": [
            "barked_aggressively",
            "growled",
